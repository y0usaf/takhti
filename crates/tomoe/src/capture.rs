...
struct SceneParts<'a> {
    ...
    layer_blurs: &'a mut HashMap<
        ...
        Vec<crate::render::framebuffer_effect::FramebufferEffect>,
    >,
    window_blurs: &'a mut HashMap<Window, crate::render::framebuffer_effect::FramebufferEffect>,
    window_properties: &'a HashMap<u64, crate::lua::WindowProperties>,
    windows: &'a HashMap<u64, Window>,
...
impl<'a> SceneParts<'a> {
    ...
    fn elements(
        ...
        if self.locked {
            ...
            let shadows = crate::render::shadow_elements(
                self.space,
                self.shadows,
                geo.loc,
                self.animations,
